...
namespace Yello.Keycloak.UserService
{
    public class KeycloakUserService : IKeycloakUserService
    {
        ...
        {
            var url = _options.Host + "/auth/admin/realms/Yello/users";
            var body = new
            {
        ...
        {
            var url = _options.Host + $"/auth/admin/realms/Yello/users/{userId}/role-mappings/clients/{_options.Id}"; ;
            var token = await AuthAsync();
        ...
        {
            var url = _options.Host + $"/auth/admin/realms/Yello/users?username={username}"; ;
            var token = await AuthAsync();
            var httpRequestMessage = new HttpRequestMessage
            {
